...
-- Fixed column names to match actual database schema: end_to_end_id instead of transaction_id, pokladnica/vatsk instead of user_pokladnica/user_vatsk
...
BEGIN
  ...
  LEFT JOIN mqtt_notifications mn 
    ON ms.end_to_end_id = mn.transaction_id 
